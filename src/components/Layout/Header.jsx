...
const Header = () => {
  return (
    <div
      className="bg-white dark:bg-slate-900/80 backdrop-blur-xl border-b 
    ...
    >
      <div className="flex items-center justify-start ">
        ...
        <div className="flex items-center space-x-4 ">
          ...
          <div className="hidden md:block ">
            ...
            <p>Welcome back, Alex! Here's whats's happenig today</p>
          </div>
        </div>
        ...
        focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all "
              ...
              <button
                className="absolute right-2 top-1/2 transform -translate-y-1/2 p-1.5 text-slate-400 hover:text-slate-600 
     dark:hover:text-slate-300"
          ...
          <div className="flex items-center space-x-3">
            ...
            text-white rounded-xl hover:shadow-lg transition-a "
            >
          ...
          transition -colors ">
            <Sun className="w-5 h-5 "/>
              ...
              dark:hover:bg-slate-800 transition-colors ">
                ...
                <span className="absolute -top-1 w-5 h-5 bg-red-500 text-white text-xs rounded-full flex items-center 
