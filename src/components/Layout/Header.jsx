...
import { Menu, Sun, Bell, Settings, Plus, Filter, ChevronDown, Search } from 'lucide-react';
import User from '../../assets/user.png';

const Header = ({ sideBarCollapsed, onToggle }) => {
  return (
    <header className="flex items-center justify-between px-6 py-4 bg-white dark:bg-slate-900/80 border-b border-slate-200 dark:border-slate-700/50 backdrop-blur-xl">
      {/* Left section */}
      ...
      <div className="flex justify-end w-full">
        <div className="flex-1 max-w-md mr-8">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-slate-100 dark:bg-slate-800 border-slate-200 dark:border-slate-700 rounded-xl text-slate-800 dark:text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
            />
        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="flex items-center space-x-3 pl-3 border-1 border-slate-200 dark:border-slate-700">
            ...
            <div className="hidden md:block">
              <p className="text-sm font-medium text-slate-500 dark:text-slate-400">Alex Jhonson</p>
